...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  SET(ROOT_LIBRARIES ${root_flags} -lSpectrum -lMinuit2)
...
#  MESSAGE("BLA: ${bla}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       ...
       ARGS -f ${OUTFILE} -c -p ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
       # -p option uses gcc preprocessor instead of cint's one, gcc prepro  is needed to run through
