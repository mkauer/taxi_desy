...
#define MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_DRS4CASCADING	(1<<6)
...
#define OFFS_ICESCINT_READOUT_DRS4CHIPSELECTOR				0x1114	// rw, 4 bit (debug for radio taxi)
#define OFFS_ICESCINT_READOUT_DEBUGFIFOOUT					0x1116	// ro, 16bit will contain one channel after offset correction
...
#define OFFS_ICESCINT_PIXELTRIGGERCOUNTER_NEWDATA					0x1048	// rw, 1bit, write '0' will reset the newData latch
...
#define VALUE_ICESCINT_DATATYPE_GPS									0x9000
#define VALUE_ICESCINT_DATATYPE_DRS4CASCADING						0xa000
...
inline static int icescint_isValidHeader(unsigned short  _header)
{
	...
	case VALUE_ICESCINT_DATATYPE_GPS:
	case VALUE_ICESCINT_DATATYPE_DRS4CASCADING:
