...
#define __RMASK(NAME, ADDRESS, MASK) 	t.nextRow(); \
	...
	__RMASK("DRS4TIMING", 	OFFS_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG, MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_DRS4TIMING);
	__RMASK("DRS4CHARGE", 	OFFS_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG, MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_DRS4CHARGE);
	__RMASK("DRS4SAMPLING", OFFS_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG, MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_DRS4SAMPLING);
	__RMASK("DEBUG", 		OFFS_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG, MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_DEBUG);
	__RMASK("TEST DATA", 	OFFS_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG, MASK_ICESCINT_READOUT_EVENTFIFOPACKETCONFIG_TEST_DATA1);

	__ROW("number of samples", 		BASE_DRS4+OFFS_DRS4_NUMBEROFSAMPLESTOREAD);
	__ROW("trigger mask", 	OFFS_ICESCINT_TRIGGERLOGIC_TRIGGERMASK);
