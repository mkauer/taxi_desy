...
FILE=${TOOLCHAIN_DOWNLOAD}/omniORBpy-4.2.0.tar.bz2
BUILD_NAME=omniORBpy-4.2.0
BUILD_DIR=${TOOLCHAIN_BUILD}/${BUILD_NAME}
URL='http://downloads.sourceforge.net/project/omniorb/omniORBpy/omniORBpy-4.2.0/omniORBpy-4.2.0.tar.bz2?&use_mirror=cznic'
